...
export const ParticleTrailV1_4 = forwardRef<ParticleTrailRef, {}>((props, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    spawn: (x: number, y: number) => {
      ...
      const speed = 1.2 + Math.random() * 2.8; // Dynamic trail
    ...
    <>
      {Array.from({ length: MAX_PARTICLES }).map((_, i) => (
        <div
          ...
          className="cursor-v1-4-particle"
        />
      ))}
    </>
  );
...
ParticleTrailV1_4.displayName = 'ParticleTrailV1_4';
