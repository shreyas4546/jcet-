...
const TESTIMONIALS = [
  {
    ...
    quote: 'JCET has provided me with the perfect platform to explore my passion for coding. The faculty support and the state-of-the-art labs are exceptional.'
  },
  {
    id: 2,
    name: 'Priya Patil',
    role: 'B.Tech AI, 3rd Year',
    image: 'https://picsum.photos/seed/priya/200/200',
    quote: 'The focus on practical learning and industry projects at JCET is what sets it apart. I feel confident and ready for the professional world.'
  },
  {
    id: 3,
    name: 'Amit Kulkarni',
    role: 'B.Tech Robotics, 2nd Year',
    image: 'https://picsum.photos/seed/amit/200/200',
    quote: 'Being part of the Robotics club at JCET has been an incredible experience. We get to work on real-world problems and participate in national competitions.'
  },
  {
    id: 4,
    ...
    quote: 'The research environment here is very encouraging. The guidance from professors has helped me publish my first paper in an international journal.'
  }
];
